...
const About = () => {
  ...
  const headingParagraph = (
    <p className='header py-2 my-4'>
      ...
      walks of life.
      <br />
      <br /> From a young age, I was captivated by the inner workings of
      computers, spending countless hours tinkering with hardware and immersing
      myself in the wonders of software development. As the years passed, my
      fascination only grew stronger, leading me to pursue a path where I could
      combine my technical skills with my thirst for discovery.
      <br />
      <br /> One of my greatest sources of inspiration is the world itself.
      Traveling has become an integral part of my life, allowing me to
      experience the beauty of different cultures, their traditions, and the
      incredible diversity that exists in our global community. Each journey is
      ...
      a constant source of excitement for me. From envisioning captivating
      designs to meticulously crafting intuitive user interfaces, I take pride
      in building websites that are not only visually stunning but also
  ...
  return (
    <section className='md:my-24 my-14 text-black h-auto'>
      <div>
